    ...
    <div className="biust-app-page-background">
      ...
      <div className="biust-app-container">
        <div className="biust-app-logo-container">
          <img src="/src/assets/optimizedd/icons/biust.webp" alt="biust Logo" className="biust-app-logo" />
        </div>
...
{errors.phone && <p className="ub-app-error">{errors.phone}</p>}
  ...
  <label className="biust-app-label">Additional Message (Optional)</label>
  <textarea
